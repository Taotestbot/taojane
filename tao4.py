...
cl = LINETCR.LINE()
cl.login(token="EpgTCDrBBWhXJT11hdxd.jYwFF96bBxEdu0hFO49E+q.kbWbO5gazWqejIdd/D2r4vuzXP5FG2qfCNH61JsgCcE=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u27259f7fde816d77835341dfa38f5efd",mid]
self = ["u27259f7fde816d77835341dfa38f5efd",mid]
admin = "u27259f7fde816d77835341dfa38f5efd"
admsa = "u27259f7fde816d77835341dfa38f5efd"
owner = "u27259f7fde816d77835341dfa38f5efd"
adminMID = "u27259f7fde816d77835341dfa38f5efd"
Creator="u27259f7fde816d77835341dfa38f5efd"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"แอดมาสนใจเช่าเชลบอทมั้ยครับ\nรับทำเชลบอทรายเดือน\nby.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ",
    "lang":"JP",
    ...
    "pname":{},
    "pro_name":{},
    "tag1":"\n🎉..แทคไม่ตอบกรุณารอสักครู่..🎉",
    "tag2":"\n😒..เอาเข้าไปแทคทำไมนักหนา..😒",
	"posts":False,
	}
...
#===========================================
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["แทคทำไม..ก็บอกว่าไม่ว่าง?😎"]
                     ret_ = "[ข้อความ อัตโนมัติ] " + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
                     for mention in mentionees:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["กูบอกว่าอย่าแทคเยอะไง",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","-_-","Alin lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
                     ret_ = "[ข้อความ อัตโนมัติ] " + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
        ...
        if op.type == 25:
            ...
            elif msg.text in ["Cmd",".คำสั่ง3"]:
                print "\nHelp pick up..."
                if wait["lang"] == "JP":
                    cl.sendText(msg.to, helpMessage2 + "")
                else:
                    cl.sendText(msg.to,helpt)
            elif msg.text in ["Help2","Sett",".คำสั่ง2"]:
                print "\nHelp pick up..."
                if wait["lang"] == "JP":
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'uab7c5ac3a62c68ec1a729bc1d944e8d7'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"สนใจเช่าติดต่อได้ที่ LIND ID \nhttp://line.me/ti/p/~xcool.py")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ")
                        ki2.sendText(msg.to,"✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯")
                        ki3.sendText(msg.to,"✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ")
                ...
                cl.sendText(msg.to,"""✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ\n\n
✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ
คำสั่งบอท siri
...
""")
                ...
                ki1.sendText(msg.to,"1 รายงานตัว  􀜁􀅔􏿿")
                ki2.sendText(msg.to,"2 รายงานตัว  􀜁􀅔􏿿")
                ki3.sendText(msg.to,"3 รายงานตัว  􀜁􀅔􏿿")
                ki4.sendText(msg.to,"4 รายงานตัว 􀜁􀅔􏿿")
                ki5.sendText(msg.to,"5 รายงานตัว 􀜁􀅔􏿿")
                ki6.sendText(msg.to,"6 รายงานตัว 􀜁􀅔􏿿")
                ki7.sendText(msg.to,"7 รายงานตัว 􀜁􀅔􏿿")
                ki8.sendText(msg.to,"8 รายงานตัว 􀜁􀅔􏿿")
                ki9.sendText(msg.to,"9 รายงานตัว 􀜁􀅔􏿿")
                ki10.sendText(msg.to,"10 รายงานตัว 􀜁􀅔􏿿")
...
#-----------------------------------------------
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"ยกเลิกการเชิญแล้ว..👌")
                else:
            ...
            elif msg.text in ["Add:on","Auto add on","Auto add:on","Add on","เปิดกันรัน"]:
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เปิดบล้อคอัตโนมัติ")
                    else:
                        cl.sendText(msg.to,"เปิดกันรันแล้ว..👌")
                else:
                    wait["autoAdd"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เปิดบล้อคออโต้แล้ว..👌")
                    else:
                        cl.sendText(msg.to,"Sudah on Bosqu")
            elif msg.text in ["Add:off","Auto add off","Auto add:off","Add off","ปิดกันรัน"]:
                if wait["autoAdd"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิดบล้อคอัตโนมัติ")
                    else:
                        cl.sendText(msg.to,"ปิดกันรันแล้ว..👌")
                else:
                    wait["autoAdd"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิดบล้อคออโต้แล้ว..👌")
                    else:
...
#===============================================
                ...
                cl.sendText(msg.to, "ความเร็ว นาที/วินาที.......")
                start = time.time()
                time.sleep(0.001)
...
#==================================================
#======================================================#
            elif "ข้อความ อัตโนมัติ" in msg.text:
...
#-------------------------------------------------
                        ...
                        cl.sendText(msg.to,"✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ")
                        cl.sendText(msg.to,"กำลังเปิดทั้งหมด......")
                        ...
                        cl.sendText(msg.to,"✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ")
                        cl.sendText(msg.to,"กำลังปิดทั้งหมด......")
                ...
                msg.contentMetadata = {'mid': 'uab7c5ac3a62c68ec1a729bc1d944e8d7'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ประธาน:ஆ๊ণℓन ചচ൮✬ŪЮط௭ี่ধՁ✬")
                msg.contentMetadata = {'mid': 'u9ff55d4817584b732e8b6f6ab752fa79'}
                cl.sendMessage(msg)
...
#-----------------------------------------------------------
            ...
            elif msg.text in ["Banlist","Mcheck","เชคดำ"]:
                if wait["blacklist"] == {}:
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cnt.to = msg.to
                cl.sendMessage(cnt)
            elif msg.text in ["อยุ่มั้ย"]:
                        cl.sendText(msg.to,"อยู่ไม่อยู่เรื่องกู...😏")
            elif msg.text in ["เฮีย","ป๊า"]:
                        cl.sendText(msg.to,"ครับยังไม่ว่าง...")
            elif msg.text in ["อยุ่ไหม",".อยู่ไหม","อยู่มั้ย"]:
                        cl.sendText(msg.to,"อยู่ยังไม่ตาย..😎😎")                        
